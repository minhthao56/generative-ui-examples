...
path_to_weather_skill = pathlib.Path(__file__).parent / "skills" / "weather-skill"
print(f"Loading weather skill from: {path_to_weather_skill}")

weather_skill = load_skill_from_dir(path_to_weather_skill)
